...
import '../add_product_screen/widgets/barcode_scanner_widget.dart';
import '../add_product_screen/widgets/category_picker_widget.dart';
import '../add_product_screen/widgets/pricing_calculator_widget.dart';
import '../add_product_screen/widgets/product_image_picker_widget.dart';
import '../add_product_screen/widgets/stock_quantity_picker_widget.dart';
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _initializeFormData() {
    ...
    _costController.text =
        (product["costPrice"] as num?)?.toStringAsFixed(2) ?? "";
    _priceController.text =
        (product["sellingPrice"] as String?)?.replaceAll('₱', '') ?? "";
    _quantityController.text = (product["stock"] as int?)?.toString() ?? "0";
    _selectedCategory = product["category"] as String?;
  }
  ...
  Future<void> _updateProduct() async {
    ...
    try {
      ...
      final updatedProduct = ProductModel(
        ...
        imagePath: _selectedImage?.path ?? widget.product["image"] as String?,
      );
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            TextButton(
              onPressed: _isFormValid() && !_isSaving ? _updateProduct : null,
              child: _isSaving
                  ? SizedBox(
                      width: 4.w,
                      height: 4.w,
